      ...
      <div className="container">
        <div className="row mt-0 mt-md-4">
          <div className="col-lg-5 col-md-6 pt-4 mt-5">
            ...
            >
              Be The Fastest In <span className="red-color">Delivering</span>{" "}
              Your Food
            </h1>
            <p className="pt-2" data-aos="fade-right" data-aos-duration="1500">
              Our Job is to filling your tummy with delicious food <br /> and
              with fast and free delivery
            </p>
            <div data-aos="fade-right" data-aos-duration="2000">
              <button className="btn btn-start text-white mt-2">
                Get Started
              </button>
            </div>
            <div
            ...
            >
              ...
              <div className="col-lg-6 col-8 pt-2 text-md-left text-center">
                ...
                <p>
                  <img src={RatingHome} className="img-fluid" />
                  4,8 (13.5k Reviews)
                </p>
              </div>
            </div>
